...
export function eats(head: Point, food: Point): boolean {
 ...
 */
export function step(snake: Point[], direction: Direction, grow: boolean): Point[] {
...
export function scoreFromLength(length: number): number {
